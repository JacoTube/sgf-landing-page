      ...
      <div className={`container ${styles.container}`}>
        <div className={styles.contentBox}>
          ...
          <div className={styles.actions}>
            ...
            <a href="mailto:info@proturmedia.com?subject=Richiesta%20Info%20Stati%20Generali%20del%20Fare" className={styles.mailLink}>
              Vuoi saperne di più? Scrivi a info@proturmedia.com
            </a>
          </div>
        </div>
      </div>
